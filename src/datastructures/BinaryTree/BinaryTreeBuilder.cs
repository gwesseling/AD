namespace AD
{
    ...
    public partial class DSBuilder
    {
        ...
        public static IBinaryTree<int> CreateBinaryTreeInt() {
            ...
            BinaryNode<int> node7 = new BinaryNode<int>(7, node1, null);
            BinaryNode<int> node8 = new BinaryNode<int>(8, null, null);
            BinaryNode<int> node2 = new BinaryNode<int>(2, node8, node7);
            BinaryNode<int> root = new BinaryNode<int>(5, node2, node6);
